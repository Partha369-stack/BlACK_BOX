 ...
 * Example: node scripts/promote-to-admin.mjs black369box@gmail.com
 */
...
if (!email) {
    ...
    console.log('Usage: node scripts/promote-to-admin.mjs <email>');
    console.log('Example: node scripts/promote-to-admin.mjs black369box@gmail.com\n');
    process.exit(1);
}
